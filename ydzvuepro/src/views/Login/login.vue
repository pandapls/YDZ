<template>
	<div id="login">
		<div id="header">
			<img src="../../assets/image/detail/left.png" class="left"  @click="back" />
			<h4>登录易点租</h4>
			<van-tabs v-model="active" color="#37A3FF">
				...
				<van-tab title="账号密码登录">
					<van-form>
						...
						<van-field v-model="password" type="password" name="pwd" label="密码" placeholder="请输入密码" id="pwd" />
						<div @click="show = true">
		...
		<div id="later">
			<form action="" method="post">
				...
				<span><a href="http://localhost:8080/#/register">立即注册</a></span>
