<template>
	<div class="goodsdetail_box">
		...
		<div class="goodsdetail_content">
			<van-tabs v-model="active" scrollspy sticky offset-top="40" color="#31a8fb" title-active-color="#31a8fb">
				<van-tab title="商品">
                    ...
                    <span>
                      <van-icon name="cross" @click="showPopup=false" size="20" />
									...
									<p class="zupin">
										<van-icon id="gou" name="passed" size="20" color="#eb283c" /> &nbsp;{{it.payTypeDes}}
    ...
    <button class="nowGoods" @click="goComfirm" >立即下单</button>
		...
		<!-- 商品规格 -->
		<div class="sku">
			<van-sku v-model="showsku" :sku="sku" :show-add-cart-btn="false" buy-text="加入购物车  " :goods="goods" @addcart="onAddCartClicked" />
		</div>
